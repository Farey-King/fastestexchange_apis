# Generated by Django 5.0.3 on 2025-08-15 11:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('BWP', 'Bwp'), ('RMB', 'Rmb'), ('ETB', 'Etb'), ('GHC', 'Ghc')], max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Login',
        ...
        migrations.CreateModel(
            name='EditableModel',
            fields=[
                ('createonlymodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='fastest_exchange.createonlymodel')),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            bases=('fastest_exchange.createonlymodel',),
        ),
        migrations.AddField(
            model_name='createonlymodel',
            name='created_by',
        ...
        migrations.AddField(
            model_name='transaction',
            name='kyc_reference',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='fastest_exchange.kyc'),
        ),
        migrations.AddField(
            model_name='transaction',
        ...
        migrations.CreateModel(
            name='Beneficiary',
            fields=[
                ('editablemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='fastest_exchange.editablemodel')),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='last name')),
                ('birthday', models.DateField(blank=True, null=True)),
            ...
            bases=('fastest_exchange.editablemodel',),
        ),
        migrations.CreateModel(
            name='ClientAccount',
            fields=[
        ...
        migrations.AddField(
            model_name='beneficiary',
            name='payment_method',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='beneficiaries', to='fastest_exchange.paymentmethod'),
        ),
    ]
